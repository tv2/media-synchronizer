...
const onAirIdleDuration = BigInt(process.env.ON_AIR_IDLE_DURATION_MS || '60000')
logger.info(`ON_AIR_IDLE_DURATION_MS: ${onAirIdleDuration}`)
const controller = new ControllerConsumer({ sourcePath, targetPath, onAirIdleDuration })
